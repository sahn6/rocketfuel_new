...
#            self.wmap = Basemap(projection='mill', lat_0 = 31.4, lon_0 = 35, width = 200000, height = 450000, resolution = 'i')
            self.wmap = Basemap(projection='lcc', resolution='i',width=8E6, height=8E6, lat_0=45, lon_0=-100,)
            self.wmap.etopo(scale=0.5, alpha=0.5)
